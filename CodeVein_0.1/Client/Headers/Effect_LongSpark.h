...
class CEffect_LongSpark final : public CGameObject
{
public:
...
protected:
	explicit CEffect_LongSpark(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CEffect_LongSpark(const CEffect_LongSpark& rhs);
	virtual ~CEffect_LongSpark() = default;
...
public:
	static CEffect_LongSpark* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
