...
class CColleague_UI final : public CUI
{
private:
	explicit CColleague_UI(_Device Graphic_Device);
	explicit CColleague_UI(const CColleague_UI& rhs);
	virtual ~CColleague_UI() = default;
...
public:
	static CColleague_UI*	Create(_Device pGraphic_Device);
