...
protected:
	explicit CNPC_Yokumo(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CNPC_Yokumo(const CNPC_Yokumo& rhs);
	virtual ~CNPC_Yokumo() = default;
...
public:
	static CNPC_Yokumo* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
