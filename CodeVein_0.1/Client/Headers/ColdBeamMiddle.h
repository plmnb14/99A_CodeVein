...
class CColdBeamMiddle final : public CMonster
{
protected:
	explicit CColdBeamMiddle(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CColdBeamMiddle(const CColdBeamMiddle& rhs);
	virtual ~CColdBeamMiddle() = default;
...
public:
	static CColdBeamMiddle* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
