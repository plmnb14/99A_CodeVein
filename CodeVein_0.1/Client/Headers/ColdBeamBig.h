...
class CColdBeamBig final : public CMonster
{
protected:
	explicit CColdBeamBig(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CColdBeamBig(const CColdBeamBig& rhs);
	virtual ~CColdBeamBig() = default;
...
public:
	static CColdBeamBig* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
