...
class CFireBullet final : public CMonster
{
protected:
	explicit CFireBullet(LPDIRECT3DDEVICE9 pGraphic_Device);
...
public:
	static CFireBullet* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
