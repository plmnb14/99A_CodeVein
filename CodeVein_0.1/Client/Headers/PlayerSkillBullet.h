...
class CPlayerSkillBullet final : public CGameObject
{
private:
	explicit CPlayerSkillBullet(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CPlayerSkillBullet(const CPlayerSkillBullet& rhs);
	virtual ~CPlayerSkillBullet() = default;
...
public:
	static CPlayerSkillBullet* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
