...
_int CMonsterUI::Update_GameObject(_double TimeDelta)
{
	...
	m_pTransformCom->Set_Pos(_v3(m_matMonsterBon->_41, m_matMonsterBon->_42 * 1.2f, m_matMonsterBon->_43));
	...
	if (0 == m_iCheck_Renderindex)
		m_pTransformCom->Set_Pos((_v3(TempBonmatrix._41, TempBonmatrix._42 * 1.2f, (TempBonmatrix._43 - 0.06f))));
	if (1 == m_iCheck_Renderindex)
		m_pTransformCom->Set_Pos((_v3(TempBonmatrix._41, TempBonmatrix._42 * 1.2f, (TempBonmatrix._43 - 0.02f))));
	if (2 == m_iCheck_Renderindex)
		m_pTransformCom->Set_Pos((_v3(TempBonmatrix._41, TempBonmatrix._42 * 1.2f, TempBonmatrix._43)));
