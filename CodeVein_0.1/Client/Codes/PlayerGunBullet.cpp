...
CPlayerGunBullet::CPlayerGunBullet(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CPlayerGunBullet::CPlayerGunBullet(const CPlayerGunBullet& rhs)
	: CGameObject(rhs)
{
}

HRESULT CPlayerGunBullet::Ready_GameObject_Prototype()
{
	return S_OK;
}

HRESULT CPlayerGunBullet::Ready_GameObject(void * pArg)
{
	if (nullptr == pArg)
	{
...
_int CPlayerGunBullet::Update_GameObject(_double TimeDelta)
{
...
_int CPlayerGunBullet::Late_Update_GameObject(_double TimeDelta)
{
...
HRESULT CPlayerGunBullet::Render_GameObject()
{
	Update_Collider();
	Render_Collider();
...
void CPlayerGunBullet::Update_Collider()
{
	_ulong matrixIdx = 0;
...
void CPlayerGunBullet::Render_Collider()
{
	for (auto& iter : m_vecAttackCol)
...
void CPlayerGunBullet::Enter_Collision()
{
	Update_Collider();
...
void CPlayerGunBullet::Update_Trails(_double TimeDelta)
{
...
void CPlayerGunBullet::Check_CollisionEvent(list<CGameObject*> plistGameObject)
{
...
HRESULT CPlayerGunBullet::Add_Component()
{
...
HRESULT CPlayerGunBullet::SetUp_ConstantTable()
{
	return S_OK;
}

HRESULT CPlayerGunBullet::Ready_Collider()
{
...
CPlayerGunBullet* CPlayerGunBullet::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CPlayerGunBullet* pInstance = new CPlayerGunBullet(pGraphic_Device);

	if (FAILED(pInstance->Ready_GameObject_Prototype()))
	{
		MSG_BOX("Failed To Creating CPlayerGunBullet");
...
CGameObject* CPlayerGunBullet::Clone_GameObject(void * pArg)
{
	CPlayerGunBullet* pInstance = new CPlayerGunBullet(*this);

	if (FAILED(pInstance->Ready_GameObject(pArg)))
	{
		MSG_BOX("Failed To Cloned CPlayerGunBullet");
		Safe_Release(pInstance);
	}
