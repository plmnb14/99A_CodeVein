#include "stdafx.h"
#include "..\Headers\FighterBlood.h"
#include "UI_Manager.h"

CFighterBlood::CFighterBlood(_Device pDevice)
	: CUI(pDevice)
{
}

CFighterBlood::CFighterBlood(const CFighterBlood & rhs)
	: CUI(rhs)
{
}

HRESULT CFighterBlood::Ready_GameObject_Prototype()
{
	CUI::Ready_GameObject_Prototype();
	return NOERROR;
}

HRESULT CFighterBlood::Ready_GameObject(void * pArg)
{
...
_int CFighterBlood::Update_GameObject(_double TimeDelta)
{
...
_int CFighterBlood::Late_Update_GameObject(_double TimeDelta)
{
...
HRESULT CFighterBlood::Render_GameObject()
{
	if (!m_bIsActive)
		return NOERROR;
...
HRESULT CFighterBlood::Add_Component()
{
	// For.Com_Transform
...
HRESULT CFighterBlood::SetUp_ConstantTable()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
...
void CFighterBlood::SetUp_Default()
{
...
void CFighterBlood::SetUp_SlotPos()
{
	_uint iIdx = 0;
...
CFighterBlood * CFighterBlood::Create(_Device pGraphic_Device)
{
	CFighterBlood* pInstance = new CFighterBlood(pGraphic_Device);
...
CGameObject * CFighterBlood::Clone_GameObject(void * pArg)
{
	CFighterBlood* pInstance = new CFighterBlood(*this);
