...
void CStatusUI::SetUp_Default()
{
	LOOP(2)
	{
		g_pManagement->Add_GameObject_ToLayer(L"GameObject_ConditionUI", SCENE_MORTAL, L"Layer_ConditionUI");
		m_vecConditionUI.push_back(static_cast<CConditionUI*>(g_pManagement->Get_GameObjectBack(L"Layer_ConditionUI", SCENE_MORTAL)));
	}
