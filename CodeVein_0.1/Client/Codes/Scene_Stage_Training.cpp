...
HRESULT CScene_Stage_Training::Ready_Layer_Enemies()
{
	...
	if (FAILED(g_pManagement->Add_GameObject_ToLayer(L"GameObject_Get_Item", SCENE_STAGE, L"Layer_Get_Item")))
		return E_FAIL;

	if (FAILED(g_pManagement->Add_GameObject_ToLayer(L"GameObject_Pickup_Item", SCENE_STAGE, L"Layer_Pickup_Item")))
		return E_FAIL;
