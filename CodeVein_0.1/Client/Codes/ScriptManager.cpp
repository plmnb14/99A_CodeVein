...
void CScriptManager::St02_Sub0()
{
	...
	case 17:
	{
		if (m_bEventTrigger[Script_Stage02][0] == false)
		{
			...
			//m_vecObjectPool[4]->Set_Enable(true); //∞’¡ˆ√—
		}
	...
	case 110:
	{
		if (m_bEventTrigger[Script_Stage02][1] == false)
		{
			...
			m_vecTrapPool[2]->Set_Enable(true); //5π¯ øπ∆º
			//m_vecObjectPool[6]->Set_Enable(true); //≈‰≈€
			//m_vecObjectPool[7]->Set_Enable(true); //≈‰≈€
		}
...
void CScriptManager::St02_Sub1()
{
	...
	case 42:
	{
		if (m_bEventTrigger[Script_Stage02][2] == false)
		{
			...
			m_vecObjectPool[9]->Set_Enable(true); //¥¡¥Î
			m_vecTrapPool[3]->Set_Enable(true); //10π¯ øπ∆º

			m_vecObjectPool[11]->Set_Enable(true); //≈‰≈€
			//m_vecObjectPool[12]->Set_Enable(true);//≈‰≈€
			m_vecObjectPool[13]->Set_Enable(true);//∞’¡ˆ√—
			m_vecObjectPool[14]->Set_Enable(true);//∞’¡ˆ√¢πÊ
			m_vecObjectPool[15]->Set_Enable(true); //≈‰≈€

			m_vecTrapPool[4]->Set_Enable(true); //16π¯ øπ∆º
			m_vecObjectPool[17]->Set_Enable(true); //º∫∞‘
			m_vecObjectPool[18]->Set_Enable(true); //≈‰≈€

			m_vecTrapPool[5]->Set_Enable(true); //19π¯ øπ∆º
			m_vecObjectPool[20]->Set_Enable(true); //∞’¡ˆ√—
			m_vecTrapPool[6]->Set_Enable(true);  //21π¯ øπ∆º
		}
...
void CScriptManager::St02_Sub2()
{
	...
	case 60:
	{
		if (m_bEventTrigger[Script_Stage02][3] == false)
		{
			...
			m_vecTrapPool[7]->Set_Enable(true);  //22π¯ øπ∆º
			m_vecObjectPool[23]->Set_Enable(true); //≈‰≈€
			m_vecObjectPool[24]->Set_Enable(true); //º∫∞‘
			m_vecObjectPool[25]->Set_Enable(true); //≈‰≈€

			m_vecTrapPool[8]->Set_Enable(true);  //26π¯ øπ∆º
			m_vecObjectPool[27]->Set_Enable(true); //∞’ƒ°√—
			m_vecObjectPool[28]->Set_Enable(true); //º∫∞‘
		}
	}
		break;
	}
...
void CScriptManager::Ready_Stage02_DynamicObject()
{
	...
	_v4 vPos[30] =
	{ 
		//Subset0 TriggerIdx17 ∞’¡ˆ(∞ÀπÊ) øπ∆º øπ∆º ¥¡¥Î ∞’¡ˆ(√—)
		...
		_v4(51.65f, 3.2f, -193.928f, 51.65f), //ø¿∑˘

		//Subset0 TriggerIdx17 øπ∆º ≈‰≈€ ≈‰≈€
		...
		//Subset1 TriggerIdx42 ¥¡¥Î ¥¡¥Î øπ∆º ≈‰≈€ ≈‰≈€ ∞’¡ˆ(√—) ∞’¡ˆ(√¢πÊ) ≈‰≈€ øπ∆º º∫∞‘ ≈‰≈€ øπ∆º ∞’¡ˆ(√—) øπ∆º
	...
	// ================================================================================================================
	//Subset1 TriggerIdx42 ¥¡¥Î ¥¡¥Î øπ∆º ≈‰≈€ ≈‰≈€ ∞’¡ˆ(√—) ∞’¡ˆ(√¢πÊ)
	//≈‰≈€ øπ∆º º∫∞‘ ≈‰≈€ øπ∆º ∞’¡ˆ(√—) øπ∆º
	{
		//¥¡¥Î
		pInstance = g_pManagement->Clone_GameObject_Return(L"Monster_Wolf",
