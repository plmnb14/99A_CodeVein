...
void CScriptManager::St02_Sub0()
{
	...
	case 17:
	{
		if (m_bEventTrigger[Script_Stage02][0] == false)
		{
			...
			m_vecObjectPool[0]->Set_Enable(true); //∞’¡ˆ∞ÀπÊ
			m_vecTrapPool[0]->Set_Enable(true); //1π¯ øπ∆º
	...
	case 110:
	{
		if (m_bEventTrigger[Script_Stage02][1] == false)
		{
			...
			m_vecTrapPool[2]->Set_Enable(true); //4π¯ øπ∆º
		}
...
void CScriptManager::St02_Sub1()
{
	...
	case 42:
	{
		if (m_bEventTrigger[Script_Stage02][2] == false)
		{
			...
			m_vecTrapPool[3]->Set_Enable(true); //6π¯ øπ∆º
			m_vecObjectPool[7]->Set_Enable(true); //≈‰≈€
			m_vecObjectPool[8]->Set_Enable(true);//∞’¡ˆ√—
			m_vecObjectPool[9]->Set_Enable(true);//∞’¡ˆ√¢πÊ

			m_vecObjectPool[10]->Set_Enable(true); //≈‰≈€
			m_vecTrapPool[4]->Set_Enable(true); //11π¯ øπ∆º
			m_vecObjectPool[12]->Set_Enable(true); //º∫∞‘
			m_vecObjectPool[13]->Set_Enable(true); //≈‰≈€
			m_vecTrapPool[5]->Set_Enable(true); //14π¯ øπ∆º

			m_vecObjectPool[15]->Set_Enable(true); //∞’¡ˆ√—
			m_vecTrapPool[6]->Set_Enable(true);  //16π¯ øπ∆º
		}
...
void CScriptManager::St02_Sub2()
{
	...
	case 60:
	{
		if (m_bEventTrigger[Script_Stage02][3] == false)
		{
			...
			m_vecTrapPool[7]->Set_Enable(true);  //17π¯ øπ∆º
			m_vecObjectPool[18]->Set_Enable(true); //≈‰≈€
			m_vecObjectPool[19]->Set_Enable(true); //º∫∞‘
			m_vecObjectPool[20]->Set_Enable(true); //≈‰≈€

			m_vecTrapPool[8]->Set_Enable(true);  //21π¯ øπ∆º
			m_vecObjectPool[22]->Set_Enable(true); //∞’ƒ°√—
			m_vecObjectPool[23]->Set_Enable(true); //º∫∞‘
		}
	}
		break;
	}
...
void CScriptManager::Ready_Stage02_DynamicObject()
{
	...
	_v4 vPos[26] =
	{ 
		//Subset0 TriggerIdx17 ∞’¡ˆ(∞ÀπÊ) øπ∆º øπ∆º ¥¡¥Î 4
		...
		//Subset0 TriggerIdx17 øπ∆º 1
		_v4(104.147f, 3.85f, -211.804f, 104.147f),

		//Subset1 TriggerIdx42 ¥¡¥Î øπ∆º ≈‰≈€ ∞’¡ˆ(√—) ∞’¡ˆ(√¢πÊ) 5
		//≈‰≈€ øπ∆º º∫∞‘ ≈‰≈€ øπ∆º 5
		//∞’¡ˆ(√—) øπ∆º 2
		...
		_v4(98.238f, 3.849f, -122.223f, 98.238f), //∞’¡ˆ√—
		_v4(85.896f, 4.019f, -103.512f, 85.896f), //øπ∆º

		//Subset2 TriggerIdx60 øπ∆º ≈‰≈€ º∫∞‘ 3
		//≈‰≈€ øπ∆º ∞’¡ˆ(√—) º∫∞‘ 4
	...
	// ================================================================================================================
	//Subset0 TriggerIdx17 ∞’¡ˆ(∞ÀπÊ) øπ∆º øπ∆º ¥¡¥Î
	{
		//∞’¡ˆ ∞ÀπÊ
		pInstance = g_pManagement->Clone_GameObject_Return(L"Monster_SwordGenji",
			&CSwordGenji::INFO(CSwordGenji::Normal, CSwordGenji::NF_Ani::Sit1, 10.f, 10.f, 2.f,
	...
	// ================================================================================================================
	//Subset1 TriggerIdx42 ¥¡¥Î øπ∆º ≈‰≈€ ∞’¡ˆ(√—) ∞’¡ˆ(√¢πÊ)
	//≈‰≈€ øπ∆º º∫∞‘ ≈‰≈€ øπ∆º 
	//∞’¡ˆ(√—) øπ∆º
	{
		//¥¡¥Î
	...
	// ================================================================================================================
	//Subset2 TriggerIdx60 øπ∆º ≈‰≈€ º∫∞‘ ≈‰≈€ øπ∆º ∞’¡ˆ(√—) º∫∞‘
	{	
		//øπ∆º ∆Æ∑¶
		pInstance = g_pManagement->Clone_GameObject_Return(L"GameObject_YetiTrap", &CYetiTrap::YETITRAPINFO(iIndex, _v3(vPos[iIndex].x, vPos[iIndex].y, vPos[iIndex].z), V3_NULL));
		pInstance->Set_Enable(true);
