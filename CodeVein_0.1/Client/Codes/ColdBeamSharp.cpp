#include "stdafx.h"
#include "..\Headers\ColdBeamSharp.h"
#include "ParticleMgr.h"
#include "Effect.h"

CColdBeamSharp::CColdBeamSharp(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CMonster(pGraphic_Device)
{
}

CColdBeamSharp::CColdBeamSharp(const CColdBeamSharp & rhs)
	: CMonster(rhs)
{
}

HRESULT CColdBeamSharp::Ready_GameObject_Prototype()
{
	return NOERROR;
}
...
_int CColdBeamSharp::Update_GameObject(_double TimeDelta)
{
...
_int CColdBeamSharp::Late_Update_GameObject(_double TimeDelta)
{
...
HRESULT CColdBeamSharp::Render_GameObject_Instancing_SetPass(CShader * pShader)
{
	Update_Collider();
	Draw_Collider();
...
HRESULT CColdBeamSharp::Update_Collider()
{
	_ulong matrixIdx = 0;
...
void CColdBeamSharp::OnCollisionEnter()
{
	// =============================================================================================
	// 충돌
	// =============================================================================================
...
void CColdBeamSharp::OnCollisionEvent(list<CGameObject*> plistGameObject)
{
	// 공격 불가능이면 체크 안함
...
HRESULT CColdBeamSharp::Add_Component()
{
	// For.Com_Transform
...
HRESULT CColdBeamSharp::SetUp_ConstantTable()
{
	return NOERROR;
}

HRESULT CColdBeamSharp::Ready_Collider()
{
...
CColdBeamSharp * CColdBeamSharp::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CColdBeamSharp* pInstance = new CColdBeamSharp(pGraphic_Device);

	if (FAILED(pInstance->Ready_GameObject_Prototype()))
	{
		MSG_BOX("Failed To Creating CColdBeamSharp");
...
CGameObject * CColdBeamSharp::Clone_GameObject(void * pArg)
{
	CColdBeamSharp* pInstance = new CColdBeamSharp(*this);

	if (FAILED(pInstance->Ready_GameObject(pArg)))
	{
		MSG_BOX("Failed To Cloned CColdBeamSharp");
		Safe_Release(pInstance);
	}
