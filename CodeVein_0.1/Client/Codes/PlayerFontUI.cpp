...
void CPlayerFontUI::Set_ScaleUp(_float _fSizeMultiply)
{
...
void CPlayerFontUI::Update_Scale()
{
	if (m_bDecreScale)
	{
...
HRESULT CPlayerFontUI::Add_Component()
{
	...
	// For.Com_Texture
	if (FAILED(CGameObject::Add_Component(SCENE_STATIC, L"Tex_Number", L"Com_Texture", (CComponent**)&m_pTexture)))
		return E_FAIL;
...
HRESULT CPlayerFontUI::SetUp_ConstantTable()
{
	if (nullptr == m_pShader)
		return E_FAIL;
...
_int CPlayerFontUI::Calc_Interval(_float _fValue)
{
	return _int();
}

_int CPlayerFontUI::Calc_LoopCnt(_float _fValue)
{
	// 소수점 출력은 안함
...
void CPlayerFontUI::Calc_NumTexIdx(_float _fValue, _int _iMaxLoopCnt)
{
	_int iOut = 0;
...
void CPlayerFontUI::Calc_BillBoard(_int iLoopCnt, _float _fInterval)
{
...
HRESULT CPlayerFontUI::Update_Matrix()
{
	return S_OK;
}
