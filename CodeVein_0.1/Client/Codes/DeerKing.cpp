...
CBT_Composite_Node * CDeerKing::Jump_Fist()
{
	...
	CBT_CreateEffect* Effect6 = Node_CreateEffect_Finite("제트팩 불꽃", L"FireBoy_FireBullet"				, L"Bone_LeftJet"	, 0.2, 50, 0.01, 0.1);
	CBT_CreateEffect* Effect7 = Node_CreateEffect_Finite("제트팩 불꽃", L"FireBoy_FireBullet"				, L"Bone_RightJet"	, 0.2, 50, 0.01, 0.1);
