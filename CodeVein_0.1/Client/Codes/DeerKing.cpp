...
CBT_Composite_Node * CDeerKing::Head_ColdBeam()
{
	...
	CBT_CreateEffect* Effect5 = Node_New_CreateEffect_Finite("눈 위로 폭발0", L"DeerKing_SnowChunk_Up_Particle_0", L"Bone_LeftCorner", nullptr, L"Self_Dir", L"Angle_Null", 1.55, 3, 0.1, 0);
	CBT_CreateEffect* Effect6 = Node_New_CreateEffect_Finite("눈 위로 폭발0", L"DeerKing_SnowChunk_Up_Particle_1", L"Bone_LeftCorner", nullptr, L"Self_Dir", L"Angle_Null", 1.55, 3, 0.1, 0);
	CBT_CreateEffect* Effect7 = Node_New_CreateEffect_Finite("눈 위로 폭발0", L"DeerKing_SnowChunk_Up_Particle_2", L"Bone_LeftCorner", nullptr, L"Self_Dir", L"Angle_Null", 1.55, 3, 0.1, 0);
	//CBT_CreateEffect* Effect5 = Node_CreateEffect_Finite("눈 위로 폭발0", L"DeerKing_SnowChunk_Up_Particle_0"	, L"Bone_LeftCorner"	, 1.55, 1, 0.01, 0);
	//CBT_CreateEffect* Effect6 = Node_CreateEffect_Finite("눈 위로 폭발1", L"DeerKing_SnowChunk_Up_Particle_1"	, L"Bone_LeftCorner"	, 1.55, 1, 0.01, 0);
	//CBT_CreateEffect* Effect7 = Node_CreateEffect_Finite("눈 위로 폭발2", L"DeerKing_SnowChunk_Up_Particle_2"	, L"Bone_LeftCorner"	, 1.55, 2, 0.01, 0);
	...
	CBT_CreateEffect* Effect9 = Node_CreateEffect_Finite("잔눈", L"DeerKing_Snow_Up_Particle_0"					, L"Bone_LeftCorner"	, 1.55, 3, 0.01, 0);
	CBT_CreateEffect* Effect10 = Node_CreateEffect_Finite("연기", L"DeerKing_IceSmoke_0"							, L"Bone_LeftCorner"	, 1.55, 1, 0.01, 0);
	CBT_CreateEffect* Effect11 = Node_CreateEffect_Finite("연기", L"DeerKing_IceSmoke_1"							, L"Bone_LeftCorner"	, 1.55, 1, 0.01, 0);
	CBT_CreateEffect* Effect12 = Node_CreateEffect_Finite("연기", L"DeerKing_IceSmoke_2"							, L"Bone_LeftCorner"	, 1.55, 1, 0.01, 0);
