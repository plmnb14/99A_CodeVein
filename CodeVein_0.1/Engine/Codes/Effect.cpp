...
void CEffect::Check_CreateDelay(_double TimeDelta)
{
...
HRESULT CEffect::Add_Component()
{
	...
	if (FAILED(CGameObject::Add_Component(SCENE_STATIC, L"Tex_Gradient", L"Com_ColorTexture", (CComponent**)&m_pColorTextureCom)))
		return E_FAIL;
...
void CEffect::Change_EffectTexture(const _tchar* _Name)
{
...
void CEffect::Change_GradientTexture(const _tchar * _Name)
{
...
void CEffect::Change_ColorTexture(const _tchar* _Name)
{
...
CEffect* CEffect::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	...
	if (FAILED(pInstance->Ready_GameObject(nullptr)))
	{
