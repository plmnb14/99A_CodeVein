...
HRESULT CMesh_Static::Ready_Component_Prototype(const _tchar * pFilePath, const _tchar * pFileName, _mat PivotMatrix)
{
	...
	for (size_t i = 0; i < m_dwNumMaterials; ++i)
	{
		...
		// C - Color
		//==================================================================================================================================
		if (FAILED(D3DXCreateTextureFromFile(m_pGraphic_Dev, szFullPath, &m_ppTextures[i].pTextures[MESHTEXTURE::TYPE_DIFFUSE_MAP])))
			return E_FAIL;
		...
		D3DXCreateTextureFromFile(m_pGraphic_Dev, szFullPath, &m_ppTextures[i].pTextures[MESHTEXTURE::TYPE_ROUGHNESS_MAP]);
		...
		// ID - Material ID
		//==================================================================================================================================
		Change_TextureFileName(szFullPath, L"T", L"ID");
