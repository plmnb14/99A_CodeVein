...
#define Node_New_CreateEffect_Finite(_name, _Effect_Tag, _Create_Pos_Key, _pTransformCom, _Dir_Key, _Angle_Key, _dService_Start_Time, _iMaxCount_Of_Execution, _dCoolTime, _dOffset) static_cast<CBT_CreateEffect*>(CManagement::Get_Instance()->Clone_Node(L"CreateEffect", CBT_Node_Manager::SERVICE, &CBT_CreateEffect::INFO2(_name, _Effect_Tag, _Create_Pos_Key, _pTransformCom, _Dir_Key, _Angle_Key, 0, _dService_Start_Time, _iMaxCount_Of_Execution, _dCoolTime, _dOffset, CBT_Service_Node::Mode::Finite, CBT_CreateEffect::One)))
...
#include "..\Headers\BT_CreateBuff.h"
